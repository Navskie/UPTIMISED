                	...
                	<div class="row">
                        ...
                        <div class="col-12 col-sm-12 col-md-3 col-lg-3 contact-box">
                            ...
                            <ul class="addressFooter">
                            	<li><i class="icon anm anm-map-marker-al" style="color: #000 !important;"></i><p>#31 Luna St. Brgy New Banicain Olongapo City</p></li>
                                <li class="phone"><i class="icon anm anm-phone-s" style="color: #000 !important;"></i><p>0999 888-4787 / 047-232-1186</p></li>
                                <li class="email"><i class="icon anm anm-envelope-l" style="color: #000 !important;"></i><p>uptimisedcorporationph@gmail.com</p></li>
                            </ul>
                        </div>
                    </div>
                </div>
