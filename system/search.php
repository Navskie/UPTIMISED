                ...
                <table id="example1" class="table table-bordered table-hover">
                    ...
                    <?php
                        ...
                        while ($order = mysqli_fetch_array($order_qry)) {
                            ...
                            $id = $order['id'];
                            $images = $order['trans_img'];
                    ?>
                    <tr>
                        <td><?php echo $number; ?></td>
                        <td class="text-center"><a target="_blank" class="btn-sm btn btn-dark" href="poid.php?id=<?php echo $order['id']; ?>"><?php echo $order['trans_poid']; ?></a></td>
                        <td>
                        ...
                        <td class="text-center"><button class="btn btn-sm btn-secondary" data-toggle="modal" data-target="#image<?php echo $id ?>"><i class="fas fa-image"></i></button></td>
