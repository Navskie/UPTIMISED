        ...
        <div class="container-fluid">
            <div class="card rounded-0">
                <div class="card-body login-card-body text-dark">
                    <div class="row">
                        <div class="col-12">
                        <span class="float-left text-primary"><b>PHILIPPINES STOCKS</b></span>
                        ...
                        <div class="col-12">
                            ...
                            <table id="example22" class="table table-bordered">
                                ...
                                <?php
                                  $code_sql = "SELECT * FROM stockist_inventory WHERE si_item_country = 'PHILIPPINES' ORDER BY si_item_stock ASC";
