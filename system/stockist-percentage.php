...
<?php
  ...
  // $employee = '';
  $state = $get_country_fetch['stockist_role'];
?>
                  ...
                  <div class="col-lg-9 col-md-12 col-sm-12 pl-2">
                    <table id="example1" class="table table-bordered table-hover">
                      ...
                      <?php
                        ...
                        $wallet_sql = "SELECT * FROM stockist_percentage INNER JOIN upti_transaction ON trans_poid = p_poid WHERE p_code = '$reseller_id' AND trans_country = '$employee' AND p_date BETWEEN '$date' AND '$today'";
