                ...
                <table id="example1" class="table table-bordered table-hover">
                    ...
                    <?php
                        ...
                        if ($employee == 'UNITED ARAB EMIRATES') {
                          $order_sql = "SELECT * FROM upti_transaction WHERE 
                          trans_status != 'On Order' AND trans_status != 'Canceled' AND trans_status != '' AND trans_status != 'Delivered' AND trans_status != 'RTS' AND trans_country = '$employee' OR
                          trans_status != 'On Order' AND trans_status != 'Canceled' AND trans_status != '' AND trans_status != 'Delivered' AND trans_status != 'RTS' AND trans_country = 'KUWAIT' OR
                          trans_status != 'On Order' AND trans_status != 'Canceled' AND trans_status != '' AND trans_status != 'Delivered' AND trans_status != 'RTS' AND trans_country = 'OMAN' OR 
                          trans_status != 'On Order' AND trans_status != 'Canceled' AND trans_status != '' AND trans_status != 'Delivered' AND trans_status != 'RTS' AND trans_country = 'QATAR' OR
                          trans_status != 'On Order' AND trans_status != 'Canceled' AND trans_status != '' AND trans_status != 'Delivered' AND trans_status != 'RTS' AND trans_country = 'BAHRAIN'
                          ORDER BY id DESC";
                        } else {
                          $order_sql = "SELECT * FROM upti_transaction WHERE 
                        trans_status != 'On Order' AND trans_status != 'Canceled' AND trans_status != '' AND trans_status != 'Delivered' AND trans_status != 'RTS' AND trans_country = '$employee' ORDER BY id DESC";
                        }
                    ...
                    <tr>
                        ...
                        <td><?php echo $order['trans_fname']; ?></td>
