        ...
        <div class="container-fluid">
            <div class="card rounded-0">
                <div class="card-body login-card-body text-dark">
                    <div class="row">
                        <div class="col-12">
                            <h4 class="float-left text-info">Canceled Orders</h4>
                            ...
                            <table id="example1" class="table table-sm table-striped table-hover border border-info">
                                ...
                                <?php
                                    ...
                                    $order_sql = "SELECT * FROM upti_transaction WHERE trans_status= 'Canceled' AND trans_country = '$country' ORDER BY trans_date ASC";
