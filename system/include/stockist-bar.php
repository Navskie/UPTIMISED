<?php  
  ...
  $role = $_SESSION['role'];
  $stockist = $_SESSION['code'];

  $stockist_info = mysqli_query($connect, "SELECT * FROM stockist WHERE stockist_code = '$stockist'");
  $stockist_fetch = mysqli_fetch_array($stockist_info);

  $country = $stockist_fetch['stockist_country'];
  $state = $stockist_fetch['stockist_role'];
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <?php
            $pending_orders = mysqli_query($connect, "SELECT * FROM upti_transaction WHERE trans_country = '$country' AND trans_status  = 'Pending'");
            $number = 0;
            foreach ($pending_orders as $data_transac) {

              $states = $data_transac['trans_state'];

              $territory_sql = mysqli_query($connect, "SELECT * FROM upti_state WHERE state_name = '$states'");
          ...
          <li class="nav-item">
            <a href="incoming-pending-order.php" class="nav-link">
              ...
              <p>
                Incoming Orders
                <span class="badge badge-danger right"><?php echo $number; ?></span>
              </p>
            </a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a href="03182023.php" class="nav-link">
          ...
          <!-- EXCLUSIVE -->
          <?php
            $rts_orders = mysqli_query($connect, "SELECT * FROM upti_transaction WHERE trans_country = '$country' AND trans_status  = 'RTS' AND trans_stockist = 'Not Received'");
            $numbers = 0;
            foreach ($rts_orders as $data_transac) {
          ...
          <li class="nav-item">
            <a href="incoming-rts-order.php" class="nav-link">
              ...
              <p>
                RTS Orders
                <span class="badge badge-danger right"><?php echo $numbers; ?></span>
              </p>
            </a>
          </li>
          <li class="nav-item">
          ...
          <?php
            ...
            if ($_SESSION['code'] == 'S1123' || $_SESSION['code'] == 'S1114' || $_SESSION['code'] == 'S1126' || $_SESSION['code'] == 'S1116' || $_SESSION['code'] == 'S1128') {
          ?>
          <li class="nav-item">
            <a href="#" class="nav-link">
