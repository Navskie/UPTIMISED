<?php
    ...
    while ($product = mysqli_fetch_array($get_product_qry)) {
        ...
        if ($check_reseller_inv_num == 0) {
            $insert_stock = "INSERT INTO stockist_inventory (si_code, si_item_code, si_item_desc, si_item_stock, si_item_date, si_item_added, si_item_country, si_item_role) VALUES ('$Ucode', '$p_code', '$p_desc', '$p_qty', '$date', '$date', '$p_country', '$p_role')";
