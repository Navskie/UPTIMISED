<?php
    ...
    if (isset($_POST['popo'])) {
        ...
        $price = $get_price_fetch['country_stockist'];
        $subtotal = $price * $qty;
                ...
                <div class="col-9">
                    <div class="form-group" style="border-radius: 0px !important;">
                        ...
                        <select class="form-control select2bs4 rounded-0" style="width: 100%;" name="code">
                            ...
                            <?php
                            $product_sql = "SELECT * FROM upti_code INNER JOIN upti_items ON upti_code.code_name = upti_items.items_code WHERE upti_code.code_status = 'Single' AND upti_code.code_name LIKE 'UP0%'";
