                        ...
                        <div class="col-12">
                            ...
                            <table id="example1" class="table table-sm table-striped table-hover border border-info">
                                ...
                                <?php
                                    ...
                                    $order_sql = "SELECT * FROM upti_transaction WHERE trans_status= 'On Process' AND trans_country = '$country' OR trans_status= 'In Transit' AND trans_country = '$country' ORDER BY trans_date ASC";
