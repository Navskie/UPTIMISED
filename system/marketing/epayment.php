...
<?php include '../include/sidebar.php'; ?>
        ...
        <div class="container-fluid">
            <div class="card rounded-0">
                <div class="card-body login-card-body text-dark">
                    <div class="row">
                        <div class="col-12">
                        <span class="float-left text-primary"><b>Electronic Payment Information</b></span>
                        ...
                        <div class="col-12">
                            ...
                            <table id="example1" class="table table-sm table-striped table-hover border border-info">
                                ...
                                <?php
                                  $epayment_sql = "SELECT * FROM upti_mod WHERE mod_status = 'epayment'";
                                ...
                                <?php
                                  include 'backend/epayment/epayment-edit.php';
                                  include 'backend/epayment/epayment-delete.php';
                                  $number++;
                                  }
                                ?>
                            </table>
  ...
  <?php include 'backend/epayment/epayment-process.php'; ?>
