...
<?php include '../include/sidebar.php'; ?>
  ...
  <div class="content-wrapper" style="background: #f8f8f8 !important">
                        ...
                        <div class="col-12">
                            ...
                            <table id="example1" class="table table-sm table-striped table-hover border border-info">
                                ...
                                <tr>
                                  ...
                                  <td class="text-center"><a href="item-package-setting.php?id=<?php echo $package['package_code']; ?>" class="btn btn-secondary btn-sm" target="_blank"><?php echo $package['package_code']; ?></a></td>
                                ...
                                <?php
                                  include 'backend/bundle/bundle-edit.php';
                                  include 'backend/bundle/bundle-delete.php';
                                  $number++;
                                  }
                                ?>
                            </table>
    ...
    <?php include 'backend/bundle/bundle-process.php'; ?>
  </div>
