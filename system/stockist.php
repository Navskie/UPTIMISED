...
<?php
    ...
    if ($check_stockist_num > 0) {
      ...
      $role = $check_stockist_f['stockist_role'];
?>
                        ...
                        <div class="col-12">
                            ...
                            <table id="example1" class="table table-sm table-striped table-hover border border-info">
                                ...
                                <?php 
                                    ...
                                    $inventory = "SELECT * FROM stockist_inventory WHERE si_code = '$code' AND si_item_desc != '' AND si_item_country = '$country' ORDER BY id DESC";
